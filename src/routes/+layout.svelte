...
<div>
	...
	<div>
		...
		<div class="hidden lg:fixed lg:inset-y-0 lg:z-20 top-20 lg:flex lg:w-72 lg:flex-col">
			<!-- Sidebar component, swap this element with another sidebar if you like -->
			<div class="flex grow flex-col gap-y-5 overflow-y-auto bg-gray-900 px-6">
				<div class="flex h-16 shrink-0 items-center">
					<a href="/dashboard"
						><img
							class="h-8 w-auto"
							src="https://cdn-icons-png.flaticon.com/128/806/806741.png"
							alt="Your Company"
						/></a
					>
					<h1 class="text-xl ml-4 text-[#ffb703] font-bold">Hello</h1>
				</div>
				<nav class="flex flex-1 flex-col">
					<ul role="list" class="flex flex-1 flex-col gap-y-7">
						<li>
							<ul role="list" class="-mx-2 space-y-1">
								{#each $activeTab as item}
									{#if item.link === '/master'}
										<li>
											<div
										...
										{#if isCheck}
											<ul>
												{#each item.tabs as tabdata, i}
													<li transition:slide={{ duration: 500, delay: 200 * (i + 1) }}>
														<a
															href="/mapping"
															class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold"
														>
